...
export default function Navbar() {
  ...
  const { categories, setIsLoaderCategories } = useContext(UserContext);
          ...
          <ul className="row container">
            ...
            {isDesktop ? (
              categories.map(category => (
                <li key={category._id}><NavLink to={`/category/${category.name}/${category._id}`} onClick={()=>setIsLoaderCategories(true)}>{category.name}</NavLink></li>
              ))
            ) : (
              <>
